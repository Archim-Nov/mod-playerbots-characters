if(TARGET modules)
    ...
    # Optional mod-npc-chat integration (suppress chat events for NPC-directed say)
    if(EXISTS "${CMAKE_SOURCE_DIR}/modules/mod-npc-chat/src/npc_chat_api.h")
        target_compile_definitions(modules PRIVATE MOD_NPC_CHAT)
        target_include_directories(modules PRIVATE
            "${CMAKE_SOURCE_DIR}/modules/mod-npc-chat/src")
        message(STATUS "[mod-playerbots-characters] mod-npc-chat found - NPC-directed say suppression enabled")
    else()
        message(STATUS "[mod-playerbots-characters] mod-npc-chat not found - NPC-directed say suppression disabled")
    endif()
